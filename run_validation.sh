...
conda activate ap
/home/hl545/miniconda3/envs/sunspot/bin/python validation.py --config-name wulver
/home/hl545/miniconda3/envs/sunspot/bin/python test.py --config-name wulver
